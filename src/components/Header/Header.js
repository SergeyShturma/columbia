    ...
    <header>
      ...
      <nav className={s.header}>
        <h2 className={s.header__logo_title}>
          Якісні оригінальні куртки фірмового бренду
          <AnimationLogo /> з офіційного магазину.
        </h2>
        <div className={s.link__wrapper}>
          <NavLink
            ...
            to="/"
          >
            <IoManOutline className={s.link_icon_all} />
            <p className={s.link_text}>Чоловічі</p>
          </NavLink>
          <NavLink
            className={({ isActive }) =>
              `${s.link} ${isActive ? s.active : ''}`
        ...
        <div className={s.phone_container}>
          <a href="https://t.me/Serg_Shturma/" className={s.icon_wrapper}>
            <BsTelegram className={s.telegram_icon} />
          </a>
          <a href="tel:+380990448874" className={s.link_phone_wrapper}>
            (099) 044-88-74
          </a>
          <a
            href="viber://chat?number=%2B380990448874"
            className={s.icon_wrapper}
          >
            <svg
              className={s.viber_icon}
